...
(function(t) {
	...
	var Ke = ue.extend({
		...
		sn = Le.Grid = rn.extend({
			...
			bgCellHtml: function(t) {
				...
				return i.unshift("fc-day", e.widgetContentClass), '<td class="' + i.join(" ") + '"' + ' data-date="' + n.format("DD-MM-YYYY") + '"' + "><span></span></td>"
			},
	...
	var mn = _e.basic = an.extend({
			...
			numberCellHtml: function(t) {
				var e, n = t.start;
				return this.dayNumbersVisible ? (e = this.dayGrid.getDayClasses(n), e.unshift("fc-day-number"), '<td class="' + e.join(" ") + '" data-date="' + n.format() + '"><span>' + n.date() + "</span></td>") : "<td/>"
			},
