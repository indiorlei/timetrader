<?php
/**
* Adds Time Trader widget.
*/
if ( ! defined( 'ABSPATH' ) ) {
	exit; // disable direct access
}

class TimeTrader_Widget extends WP_Widget {
	...
	*/
	public function __construct() {
		parent::__construct(
		'timetrader_widget', // Base ID
		'Time Trader', // Name
		array( 'description' => __( 'Time Trader', 'timetrader' ) ) // Args
		);
	}
	...
	*/
	public function widget( $args, $instance ) {
		...
		if ( isset( $instance['slider_id'] ) ) {
			...
			echo do_shortcode( "[timetrader id={$slider_id}]" );
			echo $after_widget;
		}
	}
	...
	*/
	public function form( $instance ) {
		...
		<p>
			<?php if ( $sliders ) { ?>
			<p>
				<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'timetrader' ); ?></label>
				<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
			</p>
			<label for="<?php echo $this->get_field_id( 'slider_id' ); ?>"><?php _e( 'Select Slider:', 'timetrader' ); ?></label>
